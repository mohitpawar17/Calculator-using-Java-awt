...
public class Calculator implements ActionListener{
	...
	JButton decButton, equButton, delButton, clrButton, negButton,sinButton,cosButton,logButton;
	JPanel panel;
	
	Font myFont = new Font("ariel",Font.BOLD,30);
	
	double num1=0,num2=0,result=0,result1=0;
	char operator;
	String str;
	...
	Calculator(){
		...
		for(int i =0;i<12;i++) {
          ...
          functionButtons[5].setBackground(Color.yellow);
		...
		sinButton.setBounds(50,400,100,50);
		cosButton.setBounds(150,400,100,50);
		logButton.setBounds(250,400,100,50);		
		panel = new JPanel();
